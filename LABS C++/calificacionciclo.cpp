...

{
    ...
    cout<<"Ingrese la cantidad total de estudiantes:"; // pedirle al usuario entrar cantidad total de estudiantes
    ...
    for (i = 1; i <= totalEstudiantes; i++) // se utiliza la variable de totalEstudiantes, 
                                             //determina la cantidad de veces q se repite el programa
     {
